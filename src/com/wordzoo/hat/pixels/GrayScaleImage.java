...
/******************************************************************************
 *  Compilation:  javac GrayScaleImage.java
 *  Execution:    java GrayScaleImage filename
 *  Dependencies: none
 *
 ...
 *
 *  % java GrayScaleImage mandrill.jpg
 *
 *  Remarks
 *  -------
 ...
 */
public final class GrayScaleImage implements ActionListener {
   ...
   /**
     ...
     */
    public GrayScaleImage(GrayScaleImage picture) {
   ...
   /**
    ...
    public boolean equals(Object other) {
        ...
        GrayScaleImage that = (GrayScaleImage) other;
   ...
   /**
    ...
    public String toString(int[][] img) {
        StringBuilder sb = new StringBuilder();
        int h = img.length;
        int w = img[0].length;
        
        sb.append(w +"-by-" + h + " grayscale picture (grayscale values given in hex)\n");
   ...
   public double[] getDoubleArray() {
	   int[][] reti = to2DArray();
	   double[] ret = new double[reti.length];
	   for (int row = 0; row < reti.length; row++) {
           for (int col = 0; col < reti[0].length; col++) {               
               if (isOriginUpperLeft) {               	
               		ret[row] = reti[col][row];
               }
               else {                   
            	   ret[row] = reti[col][height - row - 1];
...
//        GrayScaleImage picture = new GrayScaleImage(args[0]);
//        StdOut.printf("%d-by-%d\n", picture.width(), picture.height());
//        GrayScaleImage copy = new GrayScaleImage(picture);
//        picture.show();
//        copy.show();
//        while (!StdIn.isEmpty()) {
